...
export const NAV: readonly NavItemConfig[] = [
  ...
  { href: "/reports",          label: "Weekly Report",   icon: ClipboardList,  enabled: true,  hidden: true, section: "Intelligence", badge: null, requiredPlan: "builder" as Plan, showDot: false, unlocksAt: 7 },
