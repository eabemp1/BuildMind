...
export const NAV: readonly NavItemConfig[] = [
  ...
  { href: "/agents",           label: "Agent Workforce",  icon: BarChart3, enabled: true,  hidden: false, section: "Intelligence", badge: "NEW", showDot: false, requiredPlan: "builder" as Plan, unlocksAt: 5 },
