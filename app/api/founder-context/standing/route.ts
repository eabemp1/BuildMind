 ...
 * mattered.
 *
 * Read-only. Unlike evaluateAndCacheStageTransition (which this shares
 * its fetch with via getProjectReadiness), this route never writes
...
export async function GET(req: Request) {
  ...
  try {
    ...
    return NextResponse.json({ ok: true, data: { ...standing, projectId } });
  } catch (err) {
