            ...
            <AreaChart data={execution}>
              <defs>
                <linearGradient id="progressFill" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="var(--bm-accent)" stopOpacity={0.65} />
                  <stop offset="100%" stopColor="var(--bm-accent)" stopOpacity={0.05} />
                </linearGradient>
              </defs>
              ...
              <Tooltip />
              <Area type="monotone" dataKey="progress" stroke="var(--bm-text2)" strokeWidth={2.5} fill="url(#progressFill)" />
            </AreaChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
