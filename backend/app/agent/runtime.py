...
from backend.app.agent.ui_home import render_home_page, render_welcome_page
from backend.app.agent.json_store import atomic_json_save
from backend.app.agent.chat_helpers import (
...
from backend.app.agent.routes_memory_reminders import register_memory_reminder_routes
from backend.app.agent.routes_auth import register_auth_routes
from backend.app.agent.routes_forge import register_forge_routes, apply_forge_event
from backend.app.agent.routes_utility import register_utility_routes
from backend.app.agent.response_style import build_response_style_instruction, enforce_concise_answer, wants_detailed_response
from backend.app.agent.tool_plugins import ToolRegistry, register_builtin_tools, parse_tool_command
from backend.app.agent.web_content import (
