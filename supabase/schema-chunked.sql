-- ============================================================================
-- BuildMind Schema - CHUNKED VERSION (run in parts if full version fails)
-- This version can be run in smaller sections to identify which part fails
-- ============================================================================
...
-- STEP 2: Create utility trigger function (prerequisite for all tables)
-- ============================================================================
...
-- STEP 3: Drop all tables in dependency order (clean slate)
-- ============================================================================
...
-- TABLE: founder_context (CRITICAL - required by scheduled jobs)
...
-- ============================================================================
-- STEP 5: Create scheduled job output tables
-- ============================================================================
...
-- ============================================================================
-- STEP 6: Create project management tables
-- ============================================================================
...
-- ============================================================================
-- STEP 7: Create user-facing data tables
-- ============================================================================
...
-- ============================================================================
-- STEP 8: Create push notification table
-- ============================================================================
...
-- ============================================================================
-- STEP 9: Create analytics and reporting tables
-- ============================================================================

-- TABLE: execution_scorecards
...
-- ============================================================================
-- STEP 10: Create ventures and misc tables
-- ============================================================================

-- TABLE: ventures_blueprints
