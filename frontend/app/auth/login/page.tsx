  ...
  return (
    <div className="min-h-screen bm-bg flex flex-col items-center justify-center px-4 py-10 overflow-x-hidden"
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}
        className="w-full max-w-sm border border-[var(--bm-border)] rounded-xl overflow-hidden">

        {/* Card header */}
        <div className="px-5 py-4 border-b border-[var(--bm-border)] bm-bg3">
          <div className="text-[15px] font-medium bm-text mb-0.5 tracking-tight">Welcome back</div>
          <div className="text-[12px] bm-text3">Sign in to continue building</div>
        </div>

        {/* Card body */}
        <div className="px-5 py-5 bm-bg space-y-3">

          {/* OAuth */}
          <div className="space-y-2">
            <button onClick={() => void oauth("google")}
              className="w-full flex items-center justify-center gap-2 py-2.5 bm-bg2 border border-[var(--bm-border2)] bm-text2 text-[13px] rounded-lg cursor-pointer transition-colors hover:border-[#333]"
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 h-px bm-bg4" />
            <span className="text-[11px] bm-text4">or</span>
            <div className="flex-1 h-px bm-bg4" />
          </div>
          ...
          <form onSubmit={(e) => void onSubmit(e)} className="space-y-3">
            <div>
              <div className="text-[10px] bm-text3 uppercase tracking-wider mb-1.5">Email</div>
              <Input
                type="email"
                value={email}
                ...
                required
                autoFocus
                className="border-[var(--bm-border2)] bm-bg2 bm-text2 placeholder:text-[#666]"
              />
            </div>
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <div className="text-[10px] bm-text3 uppercase tracking-wider">Password</div>
                <Link href="/auth/reset-password" className="text-[10px] bm-text3 no-underline hover:text-[#888] transition-colors">Forgot?</Link>
              </div>
              <Input
                type="password"
                value={password}
          ...
          <div className="text-center text-[12px] bm-text3">
            New to BuildMind?{" "}
            <Link href="/auth/signup" className="bm-text2 no-underline hover:text-white transition-colors">Create account</Link>
          </div>
        </div>
      </motion.div>
    </div>
