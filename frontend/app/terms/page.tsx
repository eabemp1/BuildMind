      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
          ...
          <Section title="11. Privacy">
            <p>Your use of the Service is governed by our <a href="/privacy" style={{ color: "var(--bm-accent)" }}>Privacy Policy</a>, which is incorporated into these Terms by reference. Please read it carefully to understand how we collect, use, and protect your personal information.</p>
          </Section>
        ...
        <div style={{ marginTop: 64, paddingTop: 24, borderTop: "1px solid var(--bm-border)", display: "flex", gap: 24 }}>
          <a href="/privacy" style={{ fontSize: 13, color: "var(--bm-text3)", textDecoration: "none" }}>Privacy Policy</a>
