...
const PLAN_PRICE: Record<Plan, string> = { free: "$0", builder: "$19/mo", venture: "$19/mo" };
const PLAN_LABEL: Record<Plan, string> = { free: "Free", builder: "Builder", venture: "Builder" };
function normalizePlan(p: Plan): Plan { return p === "venture" ? "builder" : p; }
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 13, color: "var(--bm-text3)", lineHeight: 1.65, marginBottom: 20 }}>
        ...
        <span style={{ color: "var(--bm-accent)", fontWeight: 500 }}>{PLAN_LABEL[displayPlan]} plan</span>{" "}
