...
interface LimitModalContextValue { showLimit: (reason?: LimitReason) => void; }
const LimitModalContext = createContext<LimitModalContextValue>({ showLimit: () => {} });
      ...
      >
        ...
        <div style={{ padding: "24px 24px 20px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ fontSize: 11, color: "var(--bm-text4)" }}>GHS 290/mo · cancel anytime</div>
